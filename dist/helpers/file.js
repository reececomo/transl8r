...
exports.sortJsonFile = exports.saveJsonFile = exports.loadJsonFiles = exports.loadJsonFile = exports.getFilePath = void 0;
...
const loadJsonFile = (path, langCode, namespace) => {
    const file = exports.getFilePath(path, langCode, namespace);
    try {
